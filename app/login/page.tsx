...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      await login(email, password, selectedRole, selectedMode)
      ...
      <div className="relative min-h-screen bg-background">
        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12">
          ...
          <div className="mb-12 text-center">
            ...
            <h1 className="mb-2 text-4xl font-bold text-foreground">Login</h1>
        ...
        <Card className="w-full max-w-md border-border bg-card/50 p-8 backdrop-blur-xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Login as {selectedRole} in {selectedMode} mode
            </p>
          </div>
